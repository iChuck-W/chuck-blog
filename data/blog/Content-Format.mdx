...
```
<TOCInline toc={props.toc} exclude="简介" />
```

<TOCInline toc={props.toc} exclude="简介" />

- 排除`exclude`，自定义显示的标题层级`toHeading`
...
```
<TOCInline toc={props.toc} indentDepth={3}/>
```
...
```
<TOCInline toc={props.toc} fromHeading={3}/>
```
...
- [rehype-prism-plus](https://github.com/timlrx/rehype-prism-plus)，Javascript 代码高亮：
...
依赖于 Nextjs 的 [API routes](https://nextjs.org/docs/pages/building-your-application/routing/api-routes)，必须自托管或使用支持此功能的兼容平台，如 Vercel 或 Netlify。
...
- [rehype-citation](https://github.com/timlrx/rehype-citation)，`rehype-citation` 插件已添加到 v1.2.1 中的 XDM 处理管道中。这使您可以轻松地设置引文格式，并从现有的 bibtex 或 CSL-json 文件中插入参考书目。
...
将在文档末尾插入参考书目，但可以通过在预期位置指定 `[^Ref]` 标签来覆盖该参考书目。该插件使用 APA 引文格式，但也支持以下 CSL，'apa'、'vancouver'、'harvard1'、'chicago'、'mla' 或用户指定的 CSL 文件的路径。

### 自托管字体

- [Fontsource](https://fontsource.org/)

- [WebPageTest](https://www.webpagetest.org/video/compare.php?tests=220201_AiDcFH_f68a69b758454dd52d8e67493fdef7da,220201_BiDcMC_bf2d53f14483814ba61e794311dfa771)
...
- [gisus](https://github.com/giscus/giscus)

- [utterances](https://github.com/utterance/utterances)

- [disqus](https://help.disqus.com/en/)
