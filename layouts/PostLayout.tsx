...
const discussUrl = (path) => `https://www.zhihu.com/people/Chuck.W`
//  `https://www.zhihu.com/people/search?q=${encodeURIComponent(`${siteMetadata.siteUrl}/${path}`)}`
        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-gray-200 pb-8 dark:divide-gray-700 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0">
                      ...
                      <dl className="whitespace-nowrap text-sm font-medium leading-5">
                        ...
                        <dd>
                          {author.zhihu && (
                            ...
                            >
                              {author.zhihu
                                .replace('https://www.zhihu.com/people/', '@ 知乎')
                                .replace('https://x.com/', '@')}
                            </Link>
                          )}
                        </dd>
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
              <div className="prose max-w-none py-8 dark:prose-dark lg:prose-lg prose-img:rounded-xl">{children}</div>
